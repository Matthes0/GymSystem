...
public record MembershipPlanDetailsDto(Long id, String name, Plan plan, Price monthlyPrice, Integer durationInMonths, Integer maxMembers, GymDetailsDto gymDetailsDto) {
}
